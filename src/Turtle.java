...
//        bob.saveGCODE("test.gcode");
         bgcolor("grey");
         //new DrawBranches("purple","blue","skyblue","green","yellow","orange","red","pink",100,3,45);
        Worker1 wk1 = new Worker1();
        Worker2 wk2 = new Worker2();
        Worker3 wk3 = new Worker3();
        Worker4 wk4 = new Worker4();
        Worker5 wk5 = new Worker5();
        Worker6 wk6 = new Worker6();
        Worker7 wk7 = new Worker7();
        Worker8 wk8 = new Worker8();
        Thread thread1 = new Thread(wk1);
        Thread thread2 = new Thread(wk2);
        Thread thread3 = new Thread(wk3);
        Thread thread4 = new Thread(wk4);
        Thread thread5 = new Thread(wk5);
        Thread thread6 = new Thread(wk6);
        Thread thread7 = new Thread(wk7);
        Thread thread8 = new Thread(wk8);
        thread1.start();
        thread2.start();
        thread3.start();
        thread4.start();
...
//        charlie.penColor("brown");
//        charlie.right(90);
//        charlie.width(5);
//        charlie.forward(100);
//        charlie.penColor("purple");
//
...
//        dave.width(5);
//        dave.forward(100);
//        dave.penColor("skyblue");
//
//        Turtle gigi = new Turtle();
//        gigi.penColor("brown");
//        gigi.right(45);
//        gigi.width(5);
//        gigi.forward(100);
//        gigi.penColor("black");
//
//        Turtle gigi2 = new Turtle();
//        gigi2.penColor("brown");
//        gigi2.left(45);
//        gigi2.width(5);
//        gigi2.forward(100);
//        gigi2.penColor("blue");
//
//        Turtle gigi3 = new Turtle();
//        gigi3.penColor("brown");
//        gigi3.right(135);
//        gigi3.width(5);
//        gigi3.forward(100);
//        gigi3.penColor("orange");
//
//        Turtle gigi4 = new Turtle();
//        gigi4.penColor("brown");
//        gigi4.left(135);
//        gigi4.width(5);
//        gigi4.forward(100);
//        gigi4.penColor("yellow");
//        GreenBranch(bob,100,30,30);
        //drawBranches(bob, alice, charlie, dave, gigi , gigi2 ,gigi3 ,gigi4 ,80, 20, 20);
    }
//        private static void GreenBranch(Turtle turtle,double length,double angle1,double angle2){
//            if (length < 10) {
//                return;
//           }
//            turtle.forward(length*0.7);
//            turtle.right(angle1);
//            GreenBranch(turtle,length*0.7,angle1*0.8,angle2*0.8);
...
//        }
//        private static void drawBranches(Turtle turtle1, Turtle turtle2, Turtle turtle3, Turtle turtle4,Turtle turtle5, Turtle turtle6,Turtle turtle7,Turtle turtle8,double length, double angle1, double angle2) {
//            if (length < 10) {
//                return;
//            }
//            turtle1.forward(length);
//            turtle2.forward(length);
//            turtle3.forward(length);
//            turtle4.forward(length);
//            turtle5.forward(length);
//            turtle6.forward(length);
//            turtle7.forward(length);
//            turtle8.forward(length);
//            turtle1.right(angle1);
//            turtle2.right(angle1);
//            turtle3.right(angle1);
//            turtle4.right(angle1);
//            turtle5.right(angle1);
//            turtle6.right(angle1);
//            turtle7.right(angle1);
//            turtle8.right(angle1);
//            drawBranches(turtle1, turtle2, turtle3, turtle4, turtle5,turtle6,turtle7,turtle8,length*0.7, angle1*0.8, angle2*0.8);
//            turtle1.left(angle1+angle2);
//            turtle2.left(angle1+angle2);
//            turtle3.left(angle1+angle2);
//            turtle4.left(angle1+angle2);
//            turtle5.left(angle1+angle2);
//            turtle6.left(angle1+angle2);
//            turtle7.left(angle1+angle2);
//            turtle8.left(angle1+angle2);
//            drawBranches(turtle1, turtle2, turtle3, turtle4,turtle5,turtle6,turtle7,turtle8,length*0.7, angle1*0.8, angle2*0.8);
//            turtle1.right(angle2);
//            turtle2.right(angle2);
//            turtle3.right(angle2);
//            turtle4.right(angle2);
//            turtle5.right(angle2);
//            turtle6.right(angle2);
//            turtle7.right(angle2);
//            turtle8.right(angle2);
//            turtle1.backward(length);
//            turtle2.backward(length);
//            turtle3.backward(length);
//            turtle4.backward(length);
//            turtle5.backward(length);
//            turtle6.backward(length);
//            turtle7.backward(length);
//            turtle8.backward(length);
//        }
        //In this modified code, I add
